This repository contains a collection of four individual projects, each showcasing different aspects of front-end web development. The projects are implemented using HTML, CSS, and JavaScript.
